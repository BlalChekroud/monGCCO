 ...
 */
final class Version20250126154142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bird_species CHANGE wispeciescode wispeciescode VARCHAR(255) DEFAULT NULL, CHANGE authority authority VARCHAR(255) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE common_name common_name VARCHAR(255) DEFAULT NULL, CHANGE common_name_alt common_name_alt VARCHAR(100) DEFAULT NULL, CHANGE synonyms synonyms VARCHAR(255) DEFAULT NULL, CHANGE taxonomic_sources taxonomic_sources VARCHAR(500) DEFAULT NULL, CHANGE subspp_id subspp_id VARCHAR(255) DEFAULT NULL, CHANGE french_name french_name VARCHAR(255) DEFAULT NULL, CHANGE english_name english_name VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE language CHANGE updated_at updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE nature_reserve CHANGE updated_at updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE user_status CHANGE updated_at updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bird_family CHANGE sub_family sub_family VARCHAR(255) DEFAULT \'NULL\', CHANGE tribe tribe VARCHAR(255) DEFAULT \'NULL\', CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE bird_life_tax_treat CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE bird_species CHANGE french_name french_name VARCHAR(255) DEFAULT \'NULL\', CHANGE wispeciescode wispeciescode VARCHAR(255) DEFAULT \'NULL\', CHANGE authority authority VARCHAR(255) DEFAULT \'NULL\', CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\', CHANGE common_name common_name VARCHAR(255) DEFAULT \'NULL\', CHANGE common_name_alt common_name_alt VARCHAR(100) DEFAULT \'NULL\', CHANGE synonyms synonyms VARCHAR(255) DEFAULT \'NULL\', CHANGE taxonomic_sources taxonomic_sources VARCHAR(500) DEFAULT \'NULL\', CHANGE subspp_id subspp_id VARCHAR(255) DEFAULT \'NULL\', CHANGE english_name english_name VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE campaign_status CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE city CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE collected_data CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE counting_campaign CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\', CHANGE description description VARCHAR(255) DEFAULT \'NULL\'');
